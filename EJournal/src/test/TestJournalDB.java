...
public class TestJournalDB {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Press 1 to edit Journal.");
            System.out.println("Press 2 to search and view information.");
            System.out.println("Press 3 to add and remove information.");
...
//                               po.accept(x,currentDate);
                ...
                case 2://ERROR !!! Error Message saying that : orphaned case
                    while (true) {
                        ...
                        System.out.println("Press 3 to see all manuscripts submitted by an author.");
                        System.out.println("Press 4 to search for a key word.");//Might be difficult to implement, check later.
                        System.out.println("Press 5 to see all details on a manuscript.");
                        System.out.println("Press 6 to see all details on an author.");
                        System.out.println("Press 7 to see all details on a reviewer.");
                        System.out.println("Press 8 to see all details on a journal issue.");
                        System.out.println("Press 9 to exit.");
                ...
                case 3:
                    while (true) {  
                        ...
                        System.out.println("Press 2 to add a reviewer.");
                        System.out.println("Press 3 to add an affiliate.");
                        System.out.println("Press 4 to remove an author.");
                        System.out.println("Press 5 to remove a reviewer.");
                        System.out.println("Press 6 to remove an affiliate.");
